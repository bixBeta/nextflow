...
Args:
    ...
    * --mqcgenome       : A string denoting genome info. It will be used in the multiqc header and will also be used to organize results for a given run.Highly recommended for genomes supplied as path to --genomes param. 
"""
